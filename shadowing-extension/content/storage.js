...
(function (root) {
  ...
  const DEFAULTS = {
    settings: { repeat: 3, autoNext: true, autoRecord: true, rate: 1, offsetMs: 0, engine: 'webspeech', useSileroVad: false, nativeLang: 'vi', targetLang: 'de', deeplKey: '', openrouterKey: '' },
  ...
  root.SD.storage = { get, set, addAttempt, saveWord, saveSettings, toggleFavorite, getFavorites, isFavoriteList };
})(window);
